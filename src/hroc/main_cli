...
from scchr.core import ResearchExperiment, ExperimentScale, ConfigurationType


def display_menu():
    """Display the main menu"""
    print("\n" + "="*70)
    print("🧬 3C-BOT RESEARCH SIMULATOR")
    print("="*70)
    print("Theoretical Foundation: SVO, Asimov Laws, Guilford Model, Trust Theory")
    print("="*70)
    print("\n1. 🔬 Complete research experiment (all configurations)")
    print("2. 🎯 Custom experiment")
    print("3. ❌ Exit")
    print("\n" + "="*70)
